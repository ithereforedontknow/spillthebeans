...
const makeIcon = (score: number) => {
  const color = score >= 4 ? "#4a7c3f" : score >= 3 ? "#a8b99a" : "#c8d4be";
  return L.divIcon({
    className: "",
    html: `<div style="width:20px;height:20px;background:${color};border-radius:50%;border:2px solid #1a2314;box-shadow:0 0 0 1.5px ${color}40;"></div>`,
    iconSize: [20, 20],
    iconAnchor: [10, 10],
    popupAnchor: [0, -14],
  });
