          ...
          <aside className="lg:col-span-1 space-y-4">
            ...
            <div className="card p-6">
                ...
                {user && (
                  <button
                    ...
                    className={cn(
                      ...
                      isSpotSaved
                        ? "border-amber/50 text-amber bg-amber-subtle"
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                {spot.opening_hours && (
                  <span className="tag text-2xs">{spot.opening_hours}</span>
                )}
              </div>
              ...
              {hasReviewed && (
                <div className="text-center py-2 font-mono text-2xs text-amber">
              ...
              <div className="space-y-4">
                {reviews.map((rev) => (
                  <ReviewCard
                    ...
                    onLike={() =>
                      user && toggleReview.mutate({ uid: user.id, rid: rev.id })
                    }
                  />
                ))}
              </div>
