      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex gap-1 mb-8 bg-raised rounded-lg p-1 w-fit border border-border">
          {(["profile", "account"] as Tab[]).map((t) => (
            <button
              ...
              onClick={() => setTab(t)}
              className={cn(
                "px-5 py-2 rounded text-sm font-medium capitalize transition-all",
            ...
            <div className="space-y-5">
              ...
              <Field label="Bio" error={errors.bio}>
                <textarea
                  ...
                  disabled={!editing}
                  rows={3}
                  placeholder="Short intro about your work style..."
                  maxLength={200}
        ...
        {tab === "account" && (
          <div className="space-y-4">
            <div className="card p-6">
              <h3 className="font-display text-lg text-head mb-3">
                Sign-in method
              </h3>
