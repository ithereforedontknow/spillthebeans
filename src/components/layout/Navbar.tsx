...
import { Menu, X, User, Settings, LogOut, ShieldCheck, Map, Stamp, Globe, PlusCircle } from 'lucide-react'
        ...
        <Link to="/" className="flex items-center gap-2.5 group shrink-0">
          <div className="w-6 h-6 bg-amber rounded-sm flex items-center justify-center">
            <svg viewBox="0 0 16 16" width="14" height="14" fill="none">
              ...
              <rect x="10" y="5" width="3" height="1.5" rx="0.5" fill="#1a2314"/>
              <path d="M10 6.5 Q13 7 13 9 Q13 10.5 11 10.5 L10 10.5" fill="none" stroke="#1a2314" strokeWidth="1.2"/>
            </svg>
          </div>
                ...
                {drop && (
                  <>
                    ...
                    <div className="absolute right-0 top-11 z-50 w-48 bg-card border border-border rounded-lg py-1 shadow-2xl animate-fade-in">
                      ...
                      <DropItem to="/submit"    icon={PlusCircle}  onClick={() => setDrop(false)}>Submit a spot</DropItem>
